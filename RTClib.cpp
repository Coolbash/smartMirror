...
////////////////////////////////////////////////////////////////////////////////
// utility code, some of this could be exposed in the CDateTime API if needed
...
////////////////////////////////////////////////////////////////////////////////
// CDateTime implementation - ignores time zones and DST changes
...
//   CDateTime now (__DATE__, __TIME__);
...
//   CDateTime now (F(__DATE__), F(__TIME__));
...
long CDateTime::secondstime(void) const {
  long t;
  uint16_t days = date2days(yOff, m, d);
  t = time2long(days, hh, mm, ss);
  return t;
...
TimeSpan CDateTime::operator-(const CDateTime& right) {
...
void RTC_DS1307::adjust(const CDateTime& dt) {
  Wire.beginTransmission(DS1307_ADDRESS);
...
CDateTime RTC_DS1307::now() 
{
  ...
  return CDateTime (y, m, d, hh, mm, ss);
}
...
void RTC_Millis::adjust(const CDateTime& dt) 
{
    offset = dt.unixtime() - millis() / 1000;
}

CDateTime RTC_Millis::now() 
{
...
void RTC_PCF8523::adjust(const CDateTime& dt) 
{
  Wire.beginTransmission(PCF8523_ADDRESS);
...
void RTC_DS3231::adjust(const CDateTime& dt) {
